...
extern "C" {
    ...
    /*******************************************************************************************
     FaceDetection Face Image Information
     *******************************************************************************************/

    typedef struct {
        MPCChar lPath;                     // image path
        MUInt32 format;                   // image format
        MInt32  width;                     // image width
        MInt32  height;                    // image height
    } AFD_FSDK_IMAGE, *LPAFD_FSDK_IMAGE;
    ...
    //int facedetect(const char *path,const char *imageFormat,int width,int height,LPAFD_FSDK_FACERES faceResult);
